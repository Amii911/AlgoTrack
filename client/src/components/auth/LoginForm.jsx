...
const LoginForm = ({ onSuccess, onSwitchToSignup }) => {
  ...
  return (
    <div className="max-w-md mx-auto">
      <h2 className="text-center mb-6 text-white text-2xl font-semibold">Login to AlgoTrack</h2>
      ...
      <div className="text-center mt-6">
        <p className="text-gray-400">
          ...
          <button onClick={onSwitchToSignup} className="text-blue-400 underline bg-transparent border-none cursor-pointer">
            Sign up
          </button>
        </p>
      </div>
